...
client.login("ODA3MzUwNTM0OTAxMDcxOTMy.YB2txw.EuqM44OIpBAlaqqikdIqUKafFxE");
...
client.on("message", message => {
  if (message.content.startsWith(PREFIX + "tkurd")) {
    let tkurd = [
‎      "بەھرەمەند مەبە چوونکە ێئستا زەمەنی بێ نرخەکانە",
‎      "ئاواتی من بوو بەڵام بۆ کەسێکی تر ھاتە دی",
‎      ""ھەموو شتێکم لە دەست دا خۆم دۆزیەوە,
‎      "ھەرکەسێک باسی خەڵکی بۆ ھێنایت،دڵنیابە باسی تۆش بۆ خەلک دەبات",
‎      "خۆزگە درۆش کردنیش وەسڵ و غەرامەی ھەبووایە",
‎      "ئەوەندە جاڵ بۆ یەکتر هەلدەکەنن
‎ئەوەندە جاڵتان بۆنەمام هڵبکەندایە بیابانەکانیش دەبون بەدارستان...¡",
‎      "تۆزێک لە پارەکانی باوکت دور بکەوەرەوە ئینجا تێ ئەگەی پیاوەکان چۆن ئەژین",
‎      "ئەوەندە جاڵ بۆ یەکتر هەلدەکەنن
‎ئەوەندە جاڵتان بۆنەمام هڵبکەندایە بیابانەکانیش دەبون بەدارستان...¡",
‎      "هـێـندە ئـازاریـان خـسـتە دڵـمـانـەوەو بـێدەنـگ بـوویـن،،تـا ڪاڵ ڪاڵ بـوویـنـەوەو
‎بـوێـن بـە مـرۆڤـێڪۍ تـر...🥺💔",
‎      "دەترسم زۆر قسەت لەگەڵ بکەم لێم بێزار بیت وە دەترسم قسەت لەگەڵ نەکەم بڵێ لێم بێزارە🥺",
‎      "چ ژیانێکە بە خەمەوە دەخەوی 
بە خەمەوە هەڵدەستی 💆🏻‍♀️💔
‎ئیتر ژیانە....",
‎      "مــرۆڤــایـه‌تــی تابلـۆیه‌ڪــی  جـــوانه‌ ;
,چونـڪـه‌ هــونه‌رمـه‌ندێڪـی
لێهـــاتـــوو ڪێشـــاویــه‌تــــی..
",
‎      "سەرەتای هەموو شتێک بەڕاستی و ڕاستگۆیانە دەست پێبکە ، چونکە هەر ئەوەیە لەگەلت دەمێنێتەوە.",
‎      "ڪـۆچ لـە ســەر زەوی غــوربـەتــە
بــۆ ئاســمان ژووانە....!!!
",
‎      "خــۆشبــەختــی بـۆ ئـەوکـەســەی 
لـەپێـناوی خـوا ئــەژی ، لـەپێــناوی خـوا ئــەمـری..🌸
",
‎      "خەمەکانم بۆمنالێک باس کرد مەمە مژەکەی فڕیداو وتی ئا جگەرەیەکم بەری 😅💔",
    ];

    message.channel
      .send({
        embed: {
          description: `${message.author.username} Text Kurd `,
          image: {
            url: girl[Math.floor(Math.random() * girl.length)]
          }
        }
